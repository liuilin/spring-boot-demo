package com.xkcoding.pay.bean.combine;
...
public class CPrepayOrder {
    ...
    private Payer combinePlayerInfo;
    ...
    public Payer getCombinePlayerInfo() {
        return combinePlayerInfo;
    }

    public CPrepayOrder setCombinePlayerInfo(Payer combinePlayerInfo) {
