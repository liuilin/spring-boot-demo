import com.demo.rules.entity.ComparisonOperatorEntity;
import com.demo.rules.entity.Order;
import com.demo.rules.entity.Student;
import com.demo.rules.service.UserService;
...
public class DroolsTest {
    ...
    public void test1(){
        ...
        session.fireAllRules(new RuleNameStartsWithAgendaFilter("book_discount"));
    ...
    public void test4(){
        ...
        //激活规则，由Drools框架自动进行规则匹配，如果规则匹配成功，则执行当前规则
        session.fireAllRules(new RuleNameStartsWithAgendaFilter("rule_noloop"));
    ...
    public void test5(){
        ...
        //激活规则，由Drools框架自动进行规则匹配，如果规则匹配成功，则执行当前规则
        session.fireAllRules(new RuleNameStartsWithAgendaFilter("要求Student"));
    ...
    public void test6(){
        ...
        //激活规则，由Drools框架自动进行规则匹配，如果规则匹配成功，则执行当前规则
        session.fireAllRules(new RuleNameStartsWithAgendaFilter("rule_activationgroup"));
    ...
    public void test7() throws Exception{
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                session.fireUntilHalt(new RuleNameStartsWithAgendaFilter("rule_timer"));
            }
        }).start();
